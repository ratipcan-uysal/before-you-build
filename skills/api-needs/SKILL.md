...
**And an audit you were not given is not an audit that did not run.** Where one exists and did not reach you, say so, name what it would have changed here — a need derived from a step the grill called broken, and a mark it said was missing — and tell its reader which lines to re-check. Going quiet is the worst of the three, because the loss stops being visible.
